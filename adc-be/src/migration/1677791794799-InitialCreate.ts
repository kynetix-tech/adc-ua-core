...
export class InitialCreate1677791794799 implements MigrationInterface {
    name = 'InitialCreate1677791794799'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_adc_role_enum" AS ENUM('User', 'PostEditor')`);
        await queryRunner.query(`CREATE TABLE "user_adc" ("auth0_id" character varying NOT NULL, "email" character varying NOT NULL, "name" character varying(100) NOT NULL, "role" "public"."user_adc_role_enum" NOT NULL DEFAULT 'User', CONSTRAINT "UQ_6b2506e4249b7e4b8981d03112c" UNIQUE ("email"), CONSTRAINT "PK_f3231394b7eaeadabdc6f3bf1f7" PRIMARY KEY ("auth0_id"))`);
        await queryRunner.query(`CREATE TABLE "post" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP, "title" character varying(400) NOT NULL, "content" json array, "user_id" character varying, CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
