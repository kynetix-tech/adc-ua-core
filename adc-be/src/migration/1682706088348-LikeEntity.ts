...
export class LikeEntity1682706088348 implements MigrationInterface {
    name = 'LikeEntity1682706088348'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "like" ("id" SERIAL NOT NULL, "post_id" integer NOT NULL, "user_id" character varying NOT NULL, CONSTRAINT "UQ_3221edd468ef18cc93a806b74b2" UNIQUE ("post_id", "user_id"), CONSTRAINT "PK_eff3e46d24d416b52a7e0ae4159" PRIMARY KEY ("id"))`);
