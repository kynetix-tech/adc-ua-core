...
export class CreateCarMakeModelTables1679324829051 implements MigrationInterface {
    name = 'CreateCarMakeModelTables1679324829051'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "car_make" ("id" SERIAL NOT NULL, "code" character varying(55) NOT NULL, "title" character varying(55) NOT NULL, CONSTRAINT "PK_cbde9642093e4051e40d9d352a2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "car_model" ("id" SERIAL NOT NULL, "code" character varying(55) NOT NULL, "title" character varying(55) NOT NULL, "make_id" integer, CONSTRAINT "PK_525071eea12c671d67e35a5cbc8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`INSERT INTO "car_make" ("id", "code", "title") VALUES
(1, 'ACURA', 'Acura'),
(2, 'ALFA', 'Alfa Romeo'),
(3, 'AMC', 'AMC'),
...
(70, 'VOLVO', 'Volvo'),
(71, 'YUGO', 'Yugo');`);
        await queryRunner.query(`INSERT INTO "car_model" ("id", "make_id", "code", "title") VALUES
